...
public class Controle {
	...
	public static void insertPersonnel(ArrayList<String> nouvInformationsPersonnel, int idService) {
		AccesDonnees.requeteInsertPersonnel(nouvInformationsPersonnel, idService);
	}
